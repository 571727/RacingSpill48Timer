...
/**
 * Interface that is used to run general methods for a game. Made so that
 * you don't have to hardcode different styles of games in Game or Race etc.
 * Does not know of a server or client (?) but will be manipulated by it.
 * 
 * @author Jens Benz
 *
 */

public abstract class GameModeLegacy {
